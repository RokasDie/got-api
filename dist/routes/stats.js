...
var queries_1 = require("../models/queries");
var http_errors_1 = __importDefault(require("http-errors"));
var route = express_1.Router();
exports.default = (function (app) {
    app.use("/stats", route);
    route.get("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var statistics, uniqueBattleTypes, responseObject, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, queries_1.battleStatistics()];
                case 1:
                    statistics = _a.sent();
                    uniqueBattleTypes = statistics[0]["battleTypes"].map(function (battle) { return battle.name; });
                    responseObject = {
                        most_active: {
